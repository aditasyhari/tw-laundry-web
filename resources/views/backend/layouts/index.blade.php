...
<body>
  ...
  <script src="{{ asset('backend/assets/bundles/jquery-validation/dist/jquery.validate.min.js') }}"></script>
  <script src="{{ asset('backend/assets/bundles/jquery-steps/jquery.steps.min.js') }}"></script>
